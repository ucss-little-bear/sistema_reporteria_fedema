...
class FirmarReportesRevisadosView extends StatefulWidget {
  ...
  State<FirmarReportesRevisadosView> createState() =>
      _FirmarReportesRevisadosViewState();
}

class _FirmarReportesRevisadosViewState
    extends State<FirmarReportesRevisadosView>
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        const Text(
                          "Vista Previa (Revisado por Directora)",
                          style: TextStyle(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Valide los documentos aprobados por Dirección para finalizarlos o derivarlos.",
  ...
  Widget _buildBoletasView() {
    if (_boletasAgrupadas.isEmpty) return _empty("No hay boletas revisadas.");
  ...
  Widget _buildListView(List<Reporte> list, IconData icon, Color color) {
    if (list.isEmpty) return _empty("No hay documentos revisados.");
    return ListView.builder(
    ...
    return Card(
      ...
      child: ExpansionTile(
        leading: Container(
          ...
          child: const Icon(Icons.folder_shared, color: Colors.deepOrange),
        ),
